function [J_mse_1,J_mse_2,J_mse_3] = objective (set1,set2,percentage,set_name1,set_name2)
...
%regression for a multidimensional  tarining set
...
for i = 1 : r2
    J_mse_3 = J_mse_3 + (set_multivar(i,2)-y3(i))^2;
end
